...
class CNN:
    #basic structure of the cnn model
    # 2 conv layers
    # 1 max pooling layer
    # 1 conv layer
    ...
    def backward(self, dL_dinput):
        '''
        dL_dinput: gradient of loss wrt the input of the model
        '''
        # fully connected layer
        ...
        # third conv layer
        dL_dinput = self.conv3.backward(dL_dinput)
        ...
        # second conv layer
        dL_dinput = self.conv2.backward(dL_dinput)
        print("After conv2 backward", dL_dinput.shape)

        # first conv layer
        dL_dinput = self.conv1.backward(dL_dinput)
